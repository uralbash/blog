...
# -*- coding: utf-8 -*-
#
# uralbash.ru build configuration file, created by
# `ablog start` on Wed Jul 29 14:51:11 2015.
#
...
intersphinx_mapping = {
    'webhelpers': ('https://webhelpers.readthedocs.org/en/latest/', None),
    'repoze.what': ('http://what.repoze.org/docs/1.0/', None),
    'repoze.who': ('https://repozewho.readthedocs.org/en/latest/', None),
    'sqlalchemy': ('http://sqlalchemy.readthedocs.org/en/latest/', None),
    'wtform': ('https://wtforms.readthedocs.org/en/latest/', None),
    'python': ('https://docs.python.org/3/', None),
    'webob': ('http://docs.webob.org/en/latest/', None),
    'pyramid':
    ('http://docs.pylonsproject.org/projects/pyramid/en/latest/', None),
    'sacrud': ('http://sacrud.readthedocs.org/en/master/', None),
...
links_collection = {
    ...
    'trackpoint': u'https://ru.wikipedia.org/wiki/Тензометрический_джойстик',
    'graphviz': 'http://www.graphviz.org/',
    'sqlalchemy_schemadisplay':
    'https://github.com/fschulze/sqlalchemy_schemadisplay',
    'django-extension':
    'https://github.com/django-extensions/django-extensions',
    'sadisplay': 'https://pypi.python.org/pypi/sadisplay',
    'MinificationWebHelpers':
    'http://minification-webhelpers.readthedocs.org/en/latest/',
    'formalchemy': 'http://docs.formalchemy.org/',
    'tornado': 'www.tornadoweb.org/',
    'REST': 'https://ru.wikipedia.org/wiki/REST',
    'RRD': 'http://oss.oetiker.ch/rrdtool/',
    'RRDTool': 'http://oss.oetiker.ch/rrdtool/',
    'WTForm': 'http://wtforms.simplecodes.com/',
    ...
    'ablog': 'https://github.com/abakan/ablog',
...
htmlhelp_basename = 'uralbashrudoc'

def setup(app):
    app.add_javascript('metrika.js')
